...
CREATE INDEX idx_bid_evaluation_tender_id ON bid_evaluation(tender_id);
CREATE INDEX idx_bid_evaluation_proposal_id ON bid_evaluation(proposal_id);
CREATE INDEX idx_bid_evaluation_technical_status ON bid_evaluation(technical_status);
CREATE INDEX idx_tender_evaluation_status_tender_id ON tender_evaluation_status(tender_id);
